...
// Import the Prometheus remote write extension
import { PrometheusRemoteWriteOutput } from 'k6/x/prometheus-remote-write';

// Initialize Prometheus client
const prometheusOutput = new PrometheusRemoteWriteOutput({
  url: 'http://prometheus:9090/api/v1/write', // This should match your Prometheus setup
  // Add additional labels to every metric
  additionalLabels: {
    app: 'k6-load-test',
...
// Export handleSummary to send data to Prometheus
export function handleSummary(data) {
  prometheusOutput.add(data);
  
  // Also continue to generate the results.json for backward compatibility
  return {
